...
int main(int argc, char *argv[]) {
    ...
    const auto bin = make_pair(0, 700);
    const double nbin = 70;
    ...
    hist1->SetYTitle("1 / #sigma d#sigma / dp_{T}");
